  ...
  <q-page padding>
    <q-card>
      <q-card-section class="row items-center q-pb-none">
        <div class="text-h5 text-bold">របាយការណ៍នាំចូលស្តុក</div>
        <q-space/>
...
<!--              </q-td>-->
              ...
              <q-td key="purchase_date" :props="props" class="q-gutter-x-xs">
                <span class="text-h6">{{formatDateToString(props.row.purchase_date)}}</span>
              </q-td>
            </q-tr>
          </template>
        </q-table>
